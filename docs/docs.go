    ...
    "paths": {
        ...
        "/comment/updateAuditStatus": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "更新审核状态请求参数",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateAuditStatusRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "comment.CommentsVO": {
            ...
            "properties": {
                ...
                "audit_status": {
                    "$ref": "#/definitions/enums.AuditStatus"
                },
                "content": {
                    "type": "string"
                },
